                ...
                <div className="mt-auto pt-4">
                    ...
                    <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center border rounded-md dark:border-gray-600">
                            <button onClick={(e) => { e.stopPropagation(); setQuantity(prev => Math.max(1, prev - 1)); }} className="px-2 py-1 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 font-bold">-</button>
                            <input
                                type="number"
                                min="1"
                                value={quantity}
                            ...
                            />
                            <button onClick={(e) => { e.stopPropagation(); setQuantity(prev => prev + 1); }} className="px-2 py-1 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 font-bold">+</button>
                        </div>
                        <button 
