...
export const initialData: AppData = {
    ...
    products: [
      ...
      { id: 8, name: 'معطر جو Little Trees', sku: 'ACC-001', mainCategory: 'كماليات و إكسسوارات', category: 'معطرات', brand: 'Little Trees', purchasePrice: 20, sellingPrice: 35, stock: { main: 200, branch1: 100, branch2: 80, branch3: 70 }, reorderPoint: 50, description: 'معطر جو برائحة الفانيليا المنعشة.', images: ['https://i.ibb.co/YyY1qgt/air-freshener.jpg'] },
    ],
    dailySales: [],
    suppliers: [
